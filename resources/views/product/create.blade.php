    ...
    <div class="py-10 bg-white">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex">
                <!-- Images and Videos -->
                <div class="w-[45%] my-3">
                    <div class="flex flex-col items-center justify-evenly h-full space-y-5 mx-4">
                        <div>
                        ...
                        @enderror
                        <div id="trigger-image" class="border border-[#FFB906] w-[200px] h-[170px] flex items-center justify-center cursor-pointer"
                            onclick="document.getElementById('images-input').click()">
                            <input id="images-input" type="file" accept=".jpg,.jpeg,.png" multiple class="hidden"/>
                            <img src="/storage/image.svg" class="object-contain w-[53px] h-[39px]"/>
                        </div>
                        <div id="image-list" class="grid grid-cols-3 gap-x-5 gap-y-5" style="display:none;">
                            <div class="border border-[#FFB906] flex items-center justify-center cursor-pointer h-32 w-32" onclick="document.getElementById('images-input').click()">
                                <img src="/storage/image.svg" class="object-contain"/>
                            </div>
                            <template id="image-template">
                                <div class="relative" id="templateid">
                                    <button class="absolute z-50 right-0 mr-[-15px] mt-[-15px] text-2xl">
                                        <i class= "fi fi-ss-cross-circle"></i>
                                    </button>
                                    <img src="" class="object-contain w-32 h-32 border border-gray-300"/>
                                </div>
                            </template>
                        </div>
                        <div class="relative">
                            <button id="delete-video-btn" class="absolute z-50 right-0 mr-[-15px] mt-[-15px] text-2xl hidden">
                                <i class= "fi fi-ss-cross-circle"></i>
                            </button>
                            ...
                            onclick="document.getElementById('video-input').click()">
                                ...
                                <video id="video-preview" muted loop style="display:none;" name="media">
                                </video>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-[55%] my-3 mx-4">
                    ...
                    @csrf
                        <div class="flex flex-col items-start w-[532px]">
                            <div id="media-list">
                                <input id="input-media-video" name="video" type="hidden"/>
                            </div>
